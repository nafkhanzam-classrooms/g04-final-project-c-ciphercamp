    ...
    def get_full_state(self):
        ...
        for t_id, t_data in self.terminals.items():
            safe_terminals[t_id] = {
                ...
                "is_solved": t_data.get("is_solved", False),
